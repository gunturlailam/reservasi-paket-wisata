...
<head>
    ...
    <title>Laporan Perjalanan Berdasarkan Tujuan</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link hre="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        body {
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1><i class="fas fa-map-location-dot"></i> Laporan Perjalanan Berdasarkan Tujuan</h1>
    ...
    <div class="container">
        ...
        <div class="filter-section">
            <form method="GET" action="<?= base_url('pemberangkatan/laporanTujuan') ?>" class="row g-3">
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <div class="button-group">
                        ...
                        <a href="<?= base_url('pemberangkatan/laporanTujuan') ?>" class="btn btn-reset">
        ...
        <?php if ($totalData > 0): ?>
            <div class="stats-section">
                ...
                <div class="stat-card">
                    <div class="stat-label"><i class="fas fa-map-pin"></i> Tujuan</div>
                    <div class="stat-value"><?= $tujuanTerpilih ?: 'Semua' ?></div>
                </div>
                <div class="stat-card">
                    <div class="stat-label"><i class="fas fa-calendar"></i> Periode</div>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="9" class="text-center" style="padding: 40px 20px; color: #7f8c8d;">
                                    <i class="fas fa-inbox" style="font-size: 2rem; margin-bottom: 15px; opacity: 0.5; display: block;"></i>
