...
<head>
    ...
    <title>Cetak Laporan Data Pemberangkatan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body onload="window.print()">
    <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 18%;">Tanggal Berangkat</th>
                    <th style="width: 18%;">Nomor Polisi</th>
                    <th style="width: 28%;">Nama Sopir</th>
                    <th style="width: 28%;">Nama Kernet</th>
                </tr>
            </thead>
            <tbody>
                <?php
        ...
        <div class="summary">
            <strong>Total Pemberangkatan:</strong> <?= count($pemberangkatan) ?> keberangkatan
        </div>
