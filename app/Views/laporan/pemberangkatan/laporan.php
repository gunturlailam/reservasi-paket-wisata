...
<div class="laporan-container">
    ...
    <div class="laporan-actions">
        <a href="<?= site_url('/laporanpemberangkatan/cetak') ?>" class="btn-action btn-print" target="_blank">
    ...
    <div class="stats-row">
        <div class="stat-card">
            <div class="label">Total Pemberangkatan</div>
    ...
    <div class="table-responsive">
        ...
        <?php else: ?>
            <div class="no-data">
                <p>Tidak ada data pemberangkatan</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<script>
    function exportToCSV() {
        ...
        a.href = url;
        a.download = 'laporan_pemberangkatan.csv';
        a.click();
    }
</script>
