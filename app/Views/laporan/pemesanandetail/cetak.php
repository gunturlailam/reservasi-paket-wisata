...
<head>
    ...
    <title>Cetak Laporan Data Detail Pemesanan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body onload="window.print()">
    <div class="container">
        <div class="header">
            <h1>📝 LAPORAN DATA DETAIL PEMESANAN</h1>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 20%;">Tanggal Keberangkatan</th>
                    <th style="width: 20%;">Tanggal Kembali</th>
                    <th style="width: 32%;">Jumlah Penumpang</th>
                </tr>
            </thead>
            <tbody>
                <?php
        ...
        <div class="summary">
            <strong>Total Detail Pemesanan:</strong> <?= count($pemesananDetail) ?> detail
        </div>
