...
<div class="laporan-container">
    <div class="laporan-header">
        <h2>📝 Laporan Detail Pemesanan</h2>
        <span class="badge"><?= $total ?> Data</span>
    </div>

    <div class="laporan-actions">
        <a href="<?= site_url('/laporanpemesanandetail/cetak') ?>" class="btn-action btn-print" target="_blank">
    ...
    <div class="stats-row">
        <div class="stat-card">
            <div class="label">Total Detail Pemesanan</div>
            <div class="number"><?= $total ?></div>
        </div>
    </div>

    <div class="table-responsive">
        <?php if (!empty($pemesananDetail)): ?>
            <table>
                <thead>
                    <tr>
                        <th>No</th>
        ...
        <?php else: ?>
            <div class="no-data">
                <p>Tidak ada data detail pemesanan</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<script>
    function exportToCSV() {
        ...
        a.href = url;
        a.download = 'laporan_pemesanan_detail.csv';
        a.click();
    }
</script>
