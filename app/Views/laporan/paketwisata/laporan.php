...
<div class="laporan-container">
    <div class="laporan-header">
        <h2>✈️ Laporan Paket Wisata</h2>
        <span class="badge"><?= $total ?> Data</span>
    </div>

    <div class="laporan-actions">
        <a href="<?= site_url('/laporanpaketwisata/cetak') ?>" class="btn-action btn-print" target="_blank">
    ...
    <div class="stats-row">
        <div class="stat-card">
            <div class="label">Total Paket Wisata</div>
    ...
    <div class="table-responsive">
        ...
        <?php else: ?>
            <div class="no-data">
                <p>Tidak ada data paket wisata</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<script>
    function exportToCSV() {
        ...
        a.href = url;
        a.download = 'laporan_paketwisata.csv';
        a.click();
    }
</script>
