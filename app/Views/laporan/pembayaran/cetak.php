...
<head>
    ...
    <title>Cetak Laporan Data Pembayaran</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body onload="window.print()">
    <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 18%;">No Pemesanan</th>
                    <th style="width: 18%;">Nama Penyewa</th>
                    <th style="width: 18%;">Jumlah Pembayaran</th>
                    <th style="width: 18%;">Tanggal Pembayaran</th>
        ...
        <div class="summary">
            <strong>Total Pembayaran:</strong> <?= count($pembayaran) ?> pembayaran
        </div>
