...
<head>
    ...
    <title>Cetak Laporan Data Pemesanan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body onload="window.print()">
    <div class="container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 15%;">No Pemesanan</th>
                    <th style="width: 20%;">Nama Penyewa</th>
                    <th style="width: 20%;">Paket Wisata</th>
                    <th style="width: 18%;">Tanggal Pemesanan</th>
        ...
        <div class="summary">
            <strong>Total Pemesanan:</strong> <?= count($pemesanan) ?> pemesanan
        </div>
