...
<head>
    ...
    <title>Cetak Laporan Perjalanan Periode</title>
    ...
    <style>
        ...
        .periode-section .periode-detail {
            color: #495057;
            font-size: 0.95rem;
        }
...
<body>
    ...
    <div class="print-info">
        ...
        <div style="text-align: center;">
            <strong>Laporan Berdasarkan Periode</strong>
        </div>
    ...
    <div class="periode-section">
        <div class="periode-title">Periode Laporan:</div>
        <div class="periode-detail">
            <?php if ($tanggalMulai && $tanggalSelesai): ?>
                <strong>Tanggal:</strong> <?= date('d/m/Y', strtotime($tanggalMulai)) ?> - <?= date('d/m/Y', strtotime($tanggalSelesai)) ?>
            <?php elseif ($tanggalMulai): ?>
                <strong>Mulai dari:</strong> <?= date('d/m/Y', strtotime($tanggalMulai)) ?>
            <?php elseif ($tanggalSelesai): ?>
                <strong>Sampai dengan:</strong> <?= date('d/m/Y', strtotime($tanggalSelesai)) ?>
            <?php else: ?>
                <strong>Periode:</strong> Semua Data
            <?php endif; ?>

            <?php if ($tujuanTerpilih): ?>
                <br><strong>Tujuan:</strong> <?= $tujuanTerpilih ?>
            <?php else: ?>
                <br><strong>Tujuan:</strong> Semua Tujuan
            <?php endif; ?>
        </div>
    </div>
    ...
    <?php else: ?>
        ...
        <div class="summary-section">
            ...
            <?php if ($tanggalMulai && $tanggalSelesai): ?>
                <?php
                $jumlahHari = (strtotime($tanggalSelesai) - strtotime($tanggalMulai)) / (60 * 60 * 24) + 1;
                $rataRataPerHari = $totalBayar / $jumlahHari;
                ?>
                <div class="summary-row">
                    <strong>Rata-rata Pendapatan per Hari:</strong>
                    <strong>Rp <?= number_format($rataRataPerHari, 0, ',', '.') ?></strong>
                </div>
            <?php endif; ?>
        </div>
